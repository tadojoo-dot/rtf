...
var AI_SECTION_DEFS = [
  { id: "supply",   no: "①", title: "입고·생산 축소",     owner: "적정재고 초과 품목",        group: "들어올 것을 줄인다",
    desc: "담당: 공장·구매 — 이번 계획의 입고·생산을 취소·연기해 미래 공급을 줄입니다. 감축 시나리오 KPI에 반영." },
  { id: "planfix",  no: "②", title: "판매계획 현실화",    owner: "계획이 실적보다 과대",
    desc: "담당: 마케팅·영업 — 실적보다 과대한 판매계획을 하향 검토. 계획을 낮추면 소요·발주가 연쇄로 줄어듭니다. 병행 공급 감축분은 KPI 반영." },
  { id: "sellout",  no: "③", title: "재고 소진",          owner: "판매계획 없는 판매중 재고", group: "있는 것을 내보낸다",
