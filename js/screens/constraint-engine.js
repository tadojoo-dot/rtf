...
// SAP 자재유형(DW 플랜트 기준, 사용자 제공): ROH1원료·ROH2포장재·HAWA상품·HALB반제품·
// HAGU반제품(구매)·HALS반제품(수탁)·FERT완제품·FERS완제품(수탁)·PANC판촉물
// → 최종 분류로 통합: 포장재⊂자재, 반제품(수탁)⊂반제품, 완제품(수탁)⊂완제품, 판촉물→기타,
//   반제품(구매)는 "구매반제품"으로 표기(원본 파일마다 "반제품(구매)"/"구매반제품" 두 표기 혼재 → 둘 다 흡수)
var ITEM_CATEGORY_DISPLAY = {
  "ROH1":"원료","ROH2":"자재","HAWA":"상품","HALB":"반제품","HAGU":"구매반제품",
  "HALS":"반제품","FERT":"완제품","FERS":"완제품","PANC":"기타",
  "ROH":"원료","HIBE":"자재","VERP":"자재","NLAG":"자재","UNBW":"자재",
  "원료":"원료","주원료":"원료","부원료":"원료",
  "자재":"자재","소모품":"자재","포장재":"자재",
  "반제품":"반제품","세미":"반제품","반제품(수탁)":"반제품",
  "반제품(구매)":"구매반제품","구매반제품":"구매반제품",
  "재공품":"재공품",
  "완제품":"완제품","완제품(수탁)":"완제품",
  "상품":"상품","상품공급":"상품",
  "판촉물":"기타",
};
var _DISPLAY_VALID = new Set(["원료","자재","반제품","구매반제품","재공품","완제품","상품","기타","기준정보"]);
